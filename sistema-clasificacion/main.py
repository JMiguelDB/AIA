...
clasificacion1.validacion_cruzada(SGDClassifier(), 5, "L")
...
clasificacion2.validacion_cruzada(LogisticRegression(), 5, "R")
...
clasificacion3.validacion_cruzada(clasificador, 5, "T")
